...
This documentation provides a reference to the `registerOrderShipmentStep`. It belongs to the `@medusajs/medusa/core-flows` package.

This step registers a shipment for an order.

```ts title="src/workflows/my-workflow.ts"
import { createWorkflow } from "@medusajs/framework/workflows-sdk"
import { registerOrderShipmentStep } from "@medusajs/medusa/core-flows"
